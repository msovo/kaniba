bookingInbox=`<div class="mailbox-area mg-b-15">
...
bookingMailview=`<div class="mailbox-view-area mg-b-15">
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 col-md-3 col-sm-3 col-xs-12">
...
bookingMailComposer=`<div class="mailbox-compose-area mg-b-15">
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 col-md-3 col-sm-3 col-xs-12">
            <div class="hpanel shadow-inner responsive-mg-b-30">
        ...
        <div class="col-md-9 col-md-9 col-sm-9 col-xs-12">
            <div class="hpanel email-compose">
                    ...
                    <div class="p-xs">
                        <form method="get" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-11 col-md-12 col-sm-12 col-xs-12">
                                    <input id="recipient_email" type="text" class="form-control input-sm" style="display: none;"><div class="multipleInput-container"><ul></ul><input type="email" id="email_search" class="email_search multiemail"></div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="panel-body no-padding">
                    <div class="summernote6" style="display: none;">
