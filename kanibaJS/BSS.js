BSS_list_HTML=`        <div class="contacts-area mg-b-15">
...
BSS_edit_HTML=`        <div class="single-pro-review-area mt-t-30 mg-b-15">
<div class="container-fluid">
    <div class="row">
...
function ListBSSbooking(){
    $("#calenderViewHtml").slideUp()

    $("#HTML_Loader").html('')
    $("#HTML_Loader").html(BSS_list_HTML)
    
}


function EditBSSbooking(){
    $("#calenderViewHtml").slideUp()

    $("#HTML_Loader").html('')
    $("#HTML_Loader").html(BSS_edit_HTML)
